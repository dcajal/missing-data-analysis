...
ro = [resultsSupineTDP; resultsTiltTDP]; clear resultsSupineTDP resultsTiltTDP

load(strcat('Simulation/results/',category,'/iterative.mat'))
l = [resultsSupineTDP; resultsTiltTDP]; clear resultsSupineTDP resultsTiltTDP

load(strcat('Simulation/results/',category,'/iterativeNonLinear.mat'))
nl = [resultsSupineTDP; resultsTiltTDP]; clear resultsSupineTDP resultsTiltTDP
