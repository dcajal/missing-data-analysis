...
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_tdp_' fillGaps '_mhr']),'epsc'); end %#ok<*UNRCH>
...
RMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject))) % RMSE
% nRMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject)))./nanmean(aux2(:,1)) %#ok<*NOPTS> % nRMSE
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_tdp_' fillGaps '_sdnn']),'epsc'); end
...
RMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject))) % RMSE
% nRMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject)))./nanmean(aux2(:,1)) %#ok<*NOPTS> % nRMSE
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_tdp_' fillGaps '_sdsd']),'epsc'); end
...
RMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject))) % RMSE
% nRMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject)))./nanmean(aux2(:,1)) %#ok<*NOPTS> % nRMSE
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_tdp_' fillGaps '_rmssd']),'epsc'); end
...
RMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject))) % RMSE
% nRMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject)))./nanmean(aux2(:,1)) %#ok<*NOPTS> % nRMSE
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_tdp_' fillGaps '_pnn50']),'epsc'); end
...
ylabel('MHR [beats/min]')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_tdp_' fillGaps '_mhr']),'epsc'); end
...
fancyBoxplot(aux1,aux2,burstDuration,significance,true)
ylabel('SDNN [ms]')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_tdp_' fillGaps '_sdnn']),'epsc'); end
...
fancyBoxplot(aux1,aux2,burstDuration,significance,true)
ylabel('SDSD [ms]')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_tdp_' fillGaps '_sdsd']),'epsc'); end
...
fancyBoxplot(aux1,aux2,burstDuration,significance,true)
ylabel('RMSSD [ms]')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_tdp_' fillGaps '_rmssd']),'epsc'); end
...
fancyBoxplot(aux1,aux2,burstDuration,significance,true)
ylabel('pNN50 [%]')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_tdp_' fillGaps '_pnn50']),'epsc'); end
