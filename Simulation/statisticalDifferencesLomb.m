...
ro = [resultsSupineLomb; resultsTiltLomb]; clear resultsSupineLomb resultsTiltLomb

load(strcat('Simulation/results/',category,'/iterative.mat'))
l = [resultsSupineLomb; resultsTiltLomb]; clear resultsSupineLomb resultsTiltLomb

load(strcat('Simulation/results/',category,'/iterativeNonLinear.mat'))
nl = [resultsSupineLomb; resultsTiltLomb]; clear resultsSupineLomb resultsTiltLomb
