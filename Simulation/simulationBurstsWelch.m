...
fillGaps = 'incidences'; % 'ipfm' 'incidences' 'iterative'
saveFigs = false;
...
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_welch_' fillGaps '_lf']),'epsc'); end %#ok<*UNRCH>
...
% RMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject))) % RMSE
nRMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject)))./nanmean(aux2(:,1)) %#ok<*NOPTS> % nRMSE
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_welch_' fillGaps '_hf']),'epsc'); end
...
RMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject))) % RMSE
% nRMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject)))./nanmean(aux2(:,1)) %#ok<*NOPTS> % nRMSE
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_welch_' fillGaps '_lfn']),'epsc'); end
...
RMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject))) % RMSE
% nRMSE = sqrt(nansum((aux2-aux1).^2,1)./(2*length(subject)))./nanmean(aux2(:,1)) %#ok<*NOPTS> % nRMSE
if saveFigs, saveas(gcf,strcat(['images\deg_bursts_welch_' fillGaps '_lfhf']),'epsc'); end
...
ylabel('P_{LF} [ms^2]')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_welch_' fillGaps '_lf']),'epsc'); end
...
fancyBoxplot(aux1,aux2,burstDuration,significance,true)
ylabel('P_{HF} [ms^2]')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_welch_' fillGaps '_hf']),'epsc'); end
...
fancyBoxplot(aux1,aux2,burstDuration,significance,true)
ylabel('P_{LFn}')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_welch_' fillGaps '_lfn']),'epsc'); end
...
fancyBoxplot(aux1,aux2,burstDuration,significance,true)
ylabel('P_{LF}/P_{HF}')
if saveFigs, saveas(gcf,strcat(['images\ans_bursts_welch_' fillGaps '_lfhf']),'epsc'); end
